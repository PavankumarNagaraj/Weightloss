...
export const sendNutritionChartEmail = async (recipientEmail, dishName, totalCalories, ingredients, macros) => {
  try {
    ...
    // Generate HTML content using table-based layout for email client compatibility
    const htmlContent = `
      <!DOCTYPE html>
      <html>
      <head>
          ...
          <tr>
            <td align="center" style="padding: 20px 0;">
              ...
              <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; background-color: #ffffff; border-radius: 8px; overflow: hidden;">
                ...
                <!-- Header -->
                <tr>
                  <td style="background: linear-gradient(135deg, #f97316 0%, #ea580c 100%); background-color: #f97316; padding: 32px 20px; text-align: center;">
                    <h1 style="margin: 0 0 8px 0; font-size: 28px; font-weight: 700; color: #ffffff;">🍽️ Nutrition Analysis</h1>
                    <p style="margin: 0; font-size: 18px; font-weight: 500; color: #ffffff; opacity: 0.95;">${dishName}</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding: 24px 20px;">
                    ...
                    <!-- Calories Hero Box -->
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); background-color: #fef3c7; border-radius: 16px; border: 3px solid #fbbf24; margin-bottom: 24px;">
                      <tr>
                        <td style="padding: 32px 20px; text-align: center;">
                          <div style="font-size: 56px; font-weight: 800; color: #ea580c; line-height: 1; margin-bottom: 8px;">${totalCalories}</div>
                          <div style="font-size: 16px; color: #92400e; font-weight: 600; text-transform: uppercase; letter-spacing: 1px;">Total Calories</div>
                        </td>
                      </tr>
                    </table>
                    
                    <!-- Macronutrients Section -->
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border-radius: 12px; border: 1px solid #e5e7eb; margin-bottom: 20px;">
                      <tr>
                        <td style="padding: 20px;">
                          <h3 style="margin: 0 0 16px 0; font-size: 18px; font-weight: 700; color: #111827; padding-bottom: 12px; border-bottom: 3px solid #f97316;">💪 Macronutrients</h3>
                          
                          <!-- Macro Cards Grid (2x2) -->
                          <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                              <!-- Protein Card -->
                              <td width="48%" style="padding: 0 6px 12px 0;">
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: linear-gradient(135deg, #f97316 0%, #ea580c 100%); background-color: #f97316; border-radius: 12px;">
                                  <tr>
                                    <td style="padding: 20px 16px; text-align: center;">
                                      <div style="font-size: 24px; margin-bottom: 8px;">🥩</div>
                                      <div style="font-size: 32px; font-weight: 800; color: #ffffff; line-height: 1; margin: 8px 0;">${typeof macros.protein === 'number' ? macros.protein.toFixed(1) : macros.protein}g</div>
                                      <div style="font-size: 13px; color: #ffffff; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">Protein</div>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                              <!-- Carbs Card -->
                              <td width="48%" style="padding: 0 0 12px 6px;">
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: linear-gradient(135deg, #f97316 0%, #ea580c 100%); background-color: #f97316; border-radius: 12px;">
                                  <tr>
                                    <td style="padding: 20px 16px; text-align: center;">
                                      <div style="font-size: 24px; margin-bottom: 8px;">🍚</div>
                                      <div style="font-size: 32px; font-weight: 800; color: #ffffff; line-height: 1; margin: 8px 0;">${typeof macros.carbs === 'number' ? macros.carbs.toFixed(1) : macros.carbs}g</div>
                                      <div style="font-size: 13px; color: #ffffff; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">Carbs</div>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                              ...
                              <td width="48%" style="padding: 0 6px 0 0;">
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: linear-gradient(135deg, #f97316 0%, #ea580c 100%); background-color: #f97316; border-radius: 12px;">
                                  <tr>
                                    <td style="padding: 20px 16px; text-align: center;">
                                      <div style="font-size: 24px; margin-bottom: 8px;">🥑</div>
                                      <div style="font-size: 32px; font-weight: 800; color: #ffffff; line-height: 1; margin: 8px 0;">${typeof macros.fat === 'number' ? macros.fat.toFixed(1) : macros.fat}g</div>
                                      <div style="font-size: 13px; color: #ffffff; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">Fat</div>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                              <!-- Fiber Card -->
                              <td width="48%" style="padding: 0 0 0 6px;">
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: linear-gradient(135deg, #f97316 0%, #ea580c 100%); background-color: #f97316; border-radius: 12px;">
                                  <tr>
                                    <td style="padding: 20px 16px; text-align: center;">
                                      <div style="font-size: 24px; margin-bottom: 8px;">🌾</div>
                                      <div style="font-size: 32px; font-weight: 800; color: #ffffff; line-height: 1; margin: 8px 0;">${typeof macros.fiber === 'number' ? macros.fiber.toFixed(1) : macros.fiber}g</div>
                                      <div style="font-size: 13px; color: #ffffff; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">Fiber</div>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                          ...
                          <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: 20px; background-color: #f9fafb; border-radius: 8px;">
                            <tr>
                              <td style="padding: 16px;">
                                <div style="font-size: 14px; font-weight: 600; color: #374151; margin-bottom: 12px; text-align: center;">Macro Distribution</div>
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="height: 40px; border-radius: 8px; overflow: hidden;">
                                  <tr>
                                    <td width="${proteinPercent}%" style="background-color: #3b82f6; color: #ffffff; font-weight: 700; font-size: 13px; text-align: center; vertical-align: middle;">${proteinPercent > 15 ? proteinPercent + '%' : ''}</td>
                                    <td width="${carbsPercent}%" style="background-color: #10b981; color: #ffffff; font-weight: 700; font-size: 13px; text-align: center; vertical-align: middle;">${carbsPercent > 15 ? carbsPercent + '%' : ''}</td>
                                    <td width="${fatPercent}%" style="background-color: #f59e0b; color: #ffffff; font-weight: 700; font-size: 13px; text-align: center; vertical-align: middle;">${fatPercent > 15 ? fatPercent + '%' : ''}</td>
                                  </tr>
                                </table>
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: 12px;">
                                  <tr>
                                    <td width="33%" style="text-align: center; font-size: 12px; color: #374151;">
                                      <span style="display: inline-block; width: 12px; height: 12px; background-color: #3b82f6; border-radius: 50%; margin-right: 4px; vertical-align: middle;"></span>
                                      Protein ${proteinPercent}%
                                    </td>
                                    <td width="33%" style="text-align: center; font-size: 12px; color: #374151;">
                                      <span style="display: inline-block; width: 12px; height: 12px; background-color: #10b981; border-radius: 50%; margin-right: 4px; vertical-align: middle;"></span>
                                      Carbs ${carbsPercent}%
                                    </td>
                                    <td width="33%" style="text-align: center; font-size: 12px; color: #374151;">
                                      <span style="display: inline-block; width: 12px; height: 12px; background-color: #f59e0b; border-radius: 50%; margin-right: 4px; vertical-align: middle;"></span>
                                      Fat ${fatPercent}%
                                    </td>
                                  </tr>
                                </table>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border-radius: 12px; border: 1px solid #e5e7eb;">
                      <tr>
                        <td style="padding: 20px;">
                          <h3 style="margin: 0 0 16px 0; font-size: 18px; font-weight: 700; color: #111827; padding-bottom: 12px; border-bottom: 3px solid #f97316;">📊 Ingredient Breakdown</h3>
                          ${ingredients.map(ing => `
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-bottom: 1px solid #f3f4f6; padding: 12px 0;">
                              <tr>
                                <td style="font-weight: 600; color: #374151; font-size: 15px;">${ing.name}</td>
                                <td style="color: #6b7280; font-size: 13px; text-align: right; padding-right: 12px;">${ing.quantity}${ing.unit}</td>
                                <td style="color: #f97316; font-weight: 700; font-size: 15px; text-align: right; white-space: nowrap;">${ing.calories} cal</td>
                              </tr>
                            </table>
                          `).join('')}
                        </td>
                ...
                <!-- Footer -->
                <tr>
                  <td style="padding: 24px 20px; background-color: #f9fafb; border-top: 1px solid #e5e7eb; text-align: center;">
                    <div style="font-weight: 700; color: #f97316; font-size: 16px; margin-bottom: 4px;">🔥 AfterBurn Gym Cafe</div>
                    <div style="color: #6b7280; font-size: 13px; margin-bottom: 8px;">by Sutra Fitness</div>
                    <div style="color: #9ca3af; font-size: 11px;">${new Date().toLocaleString('en-US', { 
                      weekday: 'short', 
                      year: 'numeric', 
                      month: 'short', 
                      day: 'numeric',
