// Test Brevo SMTP using nodemailer
// Install first: npm install nodemailer
// Run with: node send-smtp-test.js
...
// Email content
const mailOptions = {
  from: '"Pavan Kumar" <pavan@afterburn.fit>',
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="info-box">
            ...
            <strong>Method:</strong> SMTP with TLS<br>
          ...
          <div style="background: #fffbeb; border-left: 4px solid #f59e0b; padding: 15px; border-radius: 8px; margin: 20px 0;">
            ...
            2. Enter your email: pavankuar.nagaraj@gmail.com<br>
...
console.log('📤 Sending test email to pavankumar.nagaraj@gmail.com...\n');
...
transporter.sendMail(mailOptions, (error, info) => {
  if (error) {
    ...
    console.log('🎉 Brevo SMTP is configured correctly and working!\n');
  }
});
